...
def get_data(ticker = 'QQQ'):
    ...
    hourly_data_merged['Open'] = hourly_data_merged['open']
    hourly_data_merged['High'] = hourly_data_merged['high']
    hourly_data_merged['Low'] = hourly_data_merged['low']
    hourly_data_merged['Close'] = hourly_data_merged['close']
    hourly_data_merged['Volume'] = hourly_data_merged['volume']

    hourly_data_merged = hourly_data_merged.drop(['close', 'open', 'high', 'low','volume'], axis=1)
